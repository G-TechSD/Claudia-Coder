...
- **NEVER** ask "do you want me to fix X?" when there's an obvious fix. Just fix it. Only ask when there are genuinely multiple approaches or trade-offs to consider.
