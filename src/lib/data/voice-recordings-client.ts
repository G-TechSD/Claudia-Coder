/**
 * Voice Recordings Client-Side Store
 * Client-side localStorage operations for voice recordings
 *
 * This module contains ONLY client-side code and can be safely imported by client components.
 * For server-side file operations (saving/deleting audio files), use the API routes.
 */
